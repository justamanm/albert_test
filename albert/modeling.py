...
class BertModel(object):
    ...
    def __init__(self,
        ...
        with tf.variable_scope(scope, default_name="bert"):
            ...
            # 测试：可以获取到各层的输出值
            self.sequence_output_2 = self.all_encoder_layers[-2]  # [batch_size, seq_length, hidden_size]
            ...
            with tf.variable_scope("pooler"):
                ...
                print(self.pooled_output)       # (batch_size, 312)
...
def transformer_model(input_tensor,
    ...
    all_layer_outputs = []
    # TODO albert用了4层transformer，且每层共享参数
